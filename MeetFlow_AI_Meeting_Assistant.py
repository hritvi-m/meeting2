...
.stApp {
    background:
        radial-gradient(circle at 85% 0%, rgba(6,182,212,.10), transparent 28%),
...
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #07152f 0%, #0b1f42 100%);
...
div[data-testid="stTabs"] button[aria-selected="true"] {
    background: linear-gradient(135deg, #0b2450, #2563eb) !important;
...
# Premium MeetFlow brand header.
header_col1, header_col2 = st.columns([1, 7])
with header_col1:
    st.image("meetflow_logo.png", width=150)
with header_col2:
    st.markdown(
        '<div class="mf-topbar">'
        '<div>'
