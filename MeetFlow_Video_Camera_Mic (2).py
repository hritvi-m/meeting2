...
Install dependencies:
    ...
    # requirements.txt must include streamlit-webrtc and aiortc.
    ...
    if active_code:
        ...
        if room:
            ...
            if not room.get("started_at"):
                ...
                recording_path = Path(VIDEO_DIR) / f"{active_code}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.webm"
                st.session_state["meeting_recording_path"] = str(recording_path)
